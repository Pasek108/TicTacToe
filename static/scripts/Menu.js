...
class Menu {
  ...
  loadGame(evt) {
    ...
    switch (this.gamemode_id) {
      case 0:
        this.game = new NormalMode(this.gamemode_id, this.versus_id, this.player_id, maximalize, marks, size, change)
        break
      case 1:
        this.game = new MovableMode(this.gamemode_id, this.versus_id, this.player_id, maximalize, marks, size, change)
        break
      case 2:
        this.game = new OneMarkMode(this.gamemode_id, this.versus_id, this.player_id, maximalize, marks, size, change)
        break
    }
